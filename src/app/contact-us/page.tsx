          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="text-white">
              ...
              <div className="flex gap-3 flex-wrap">
                <a 
                  ...
                  className="w-12 h-12 bg-[#dc2626] hover:bg-[#b91c1c] flex items-center justify-center rounded transition-colors duration-300"
                >
            ...
            <div>
              <form className="space-y-3 md:space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white border border-gray-500 text-gray-900 rounded focus:outline-none focus:ring-2 focus:ring-[#d61d1b]"
                    />
                  </div>
                  <div>
                    <label className="block text-white font-medium mb-2 text-sm uppercase">EMAIL</label>
                    <input
                      type="email"
                      name="email"
                ...
                <div>
                  <label className="block text-white font-medium mb-2 text-sm uppercase">SUBJECT</label>
                  <input
                    type="text"
                    name="subject"
                ...
                <div>
                  <label className="block text-white font-medium mb-2 text-sm uppercase">MESSAGE</label>
                  <textarea
                    name="message"
