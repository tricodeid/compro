    ...
    <main className="font-sans">
      ...
      <section className="bg-[#394959] text-white py-20" data-aos="fade-in">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-light tracking-wide mb-4" data-aos="fade-down">{currentContent.pageTitle}</h1>
        </div>
      </section>
      <section className="py-16 bg-white text-[#394959]" data-aos="fade-up">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-light text-center mb-2" data-aos="zoom-in">{currentContent.sectionTitle}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            <div className="bg-[#2d5c88] p-8 rounded shadow" data-aos="fade-up" data-aos-delay="200">
              <h2 className="text-xl sm:text-2xl font-bold mb-2">{currentContent.article1Title}</h2>
              <p className="text-base sm:text-lg text-gray-700">{currentContent.article1Text}</p>
            </div>
            <div className="bg-[#2d5c88] p-8 rounded shadow" data-aos="fade-up" data-aos-delay="300">
              <h2 className="text-xl sm:text-2xl font-bold mb-2">{currentContent.article2Title}</h2>
              <p className="text-base sm:text-lg text-gray-700">{currentContent.article2Text}</p>
            </div>
            <div className="bg-[#2d5c88] p-8 rounded shadow" data-aos="fade-up" data-aos-delay="400">
              <h2 className="text-xl sm:text-2xl font-bold mb-2">{currentContent.article3Title}</h2>
              <p className="text-base sm:text-lg text-gray-700">{currentContent.article3Text}</p>
            </div>
          </div>
        </div>
      </section>
