...
const CallToActionBlocks = () => {
  ...
  const translations = {
    en: {
      ...
      block1Text: "Whether you are in charge of maintenance in your plant or a mechanical contractor, PETROSEAL will help you to set up and organize your leak sealing structure !",
    ...
    id: {
      ...
      block1Text: "Baik Anda bertanggung jawab atas pemeliharaan di pabrik Anda atau kontraktor mekanik, PETROSEAL akan membantu Anda untuk mengatur dan mengorganisir struktur penyegelan kebocoran Anda!",
      ...
      block3Text: "Proses perintis kami memungkinkan untuk melakukan penyegelan kebocoran yang andal dan aman.",
