...
export default function AchievementsPage() {
  ...
  const [imageErrors, setImageErrors] = useState<boolean[]>(new Array(9).fill(false));

  // Array of achievement images with fallback to dummy images
  const achievementImages = [
    'https://petroseal.com.my/wp-content/uploads/2019/12/WhatsApp-Image-2019-12-04-at-12.14.29-PM-400x533.jpeg',
    'https://petroseal.com.my/wp-content/uploads/2019/12/WhatsApp-Image-2019-12-04-at-12.14.28-PM-400x300.jpeg',
    'https://petroseal.com.my/wp-content/uploads/2019/12/WhatsApp-Image-2019-12-04-at-12.14.28-PM-2-400x300.jpeg',
    'https://petroseal.com.my/wp-content/uploads/2019/12/Picture4-400x477.jpg',
    'https://petroseal.com.my/wp-content/uploads/2019/12/WhatsApp-Image-2019-12-04-at-12.14.28-PM-1-400x533.jpeg',
    'https://petroseal.com.my/wp-content/uploads/2019/12/Picture5-400x276.jpg',
    'https://petroseal.com.my/wp-content/uploads/2019/12/Picture1-1-400x456.jpg',
    'https://petroseal.com.my/wp-content/uploads/2019/12/Picture2-400x438.jpg',
    'https://petroseal.com.my/wp-content/uploads/2019/12/Picture3-400x484.jpg',
  ];
  ...
  const showPrevImage = () => {
    setCurrentImageIndex((prevIndex) => (prevIndex - 1 + achievementImages.length) % achievementImages.length);
  };
  ...
  const getImageSrc = (index: number) => {
    return imageErrors[index] ? dummyImages[index] : achievementImages[index];
  };
    ...
    <main className="font-sans bg-white">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          {/* Masonry-style Grid for Certificates and Awards */}
        ...
        >
          ...
          <div className="flex-1 flex items-center justify-center p-8 relative">
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/70 text-white px-4 py-2 rounded-full text-sm font-medium">
              {currentImageIndex + 1} / {achievementImages.length}
            </div>
          </div>
