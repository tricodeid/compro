...
export default function ContactUsPage() {
  ...
  return (
    <main className="font-sans bg-white">
      ...
      {/* Hero Section */}
      <section className="relative py-24 bg-[#2d3e50]" style={{ backgroundImage: 'url(/images/9121424.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="absolute inset-0 bg-[#2d3e50]/80"></div>
        <div className="relative container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4" data-aos="fade-up">
            GET IN TOUCH
          </h1>
          <div className="w-24 h-1 bg-white mx-auto mb-6"></div>
          <p className="text-xl md:text-2xl text-white" data-aos="fade-up" data-aos-delay="100">
            ...
            <div className="text-white" data-aos="fade-right">
              ...
              <div className="flex gap-3">
                <a 
                  ...
                  className="w-10 h-10 bg-[#dc2626] hover:bg-[#b91c1c] flex items-center justify-center rounded transition-colors duration-300"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-0 focus:outline-none focus:ring-2 focus:ring-[#dc2626]"
                    required
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="px-8 py-3 bg-[#dc2626] hover:bg-[#b91c1c] text-white font-bold transition-colors duration-300"
                >
                  SUBMIT MESSAGE
                </button>
              </form>
